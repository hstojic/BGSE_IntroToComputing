...
```{r, Setup_and_Loading_Data, echo=FALSE}
    ...
    # rmarkdown::render("session1_bash.Rmd", "rmarkdown::tufte_handout", clean=TRUE)
    # rmarkdown::render("session1_bash.Rmd", "html_document", clean=TRUE)

    # rmarkdown::render("session1_bash.Rmd", "tufterhandout::html_tufte_handout", clean=TRUE)
    # rmarkdown::render("session1_bash.Rmd", "pdf_document", clean=TRUE)
...
Unix is the chosen computing environment in the Data Science Master program. Unix is any Linux or Mac operating system. Below I will use Unix and Linux interchangeably, but bear in mind that Mac is included as well.   
