...
do
    ...
    wget "$site?q=NYSE:$series&startdate=Jan+1,2008&enddate=Jan+1,2010&output=csv"
...
The script is going to connect to the website `http://www.google.com/finance`, download stock prices for the stocks BAC and IBM, clean the data files and save them in the current directory.
