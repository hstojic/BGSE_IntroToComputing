...
```{r, Setup_and_Loading_Data, echo=FALSE}
    ...
    # rmarkdown::render("session2_Rbasics.Rmd", "rmarkdown::tufte_handout", clean=TRUE)
    # rmarkdown::render("session2_Rbasics.Rmd", "html_document", clean=TRUE)

    # rmarkdown::render("session2_Rbasics.Rmd", "tufterhandout::html_tufte_handout", clean=TRUE)
    # rmarkdown::render("session2_Rbasics.Rmd", "pdf_document", clean=TRUE)
