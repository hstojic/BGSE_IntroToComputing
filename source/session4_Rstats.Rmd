---
title: "Computing 4 - Basic analysis & Other topics"
...
```{r, Setup_and_Loading_Data, echo=FALSE}
    ...
    # rmarkdown::render("session4_Rstats.Rmd", "rmarkdown::tufte_handout", clean=TRUE)
    # rmarkdown::render("session4_Rstats.Rmd", "html_document", clean=TRUE)

    # rmarkdown::render("session4_Rstats.Rmd", "tufterhandout::html_tufte_handout", clean=TRUE)
    # rmarkdown::render("session4_Rstats.Rmd", "pdf_document", clean=TRUE)
