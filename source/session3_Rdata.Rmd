---
title: "Computing 3 - Data manipulation"
...
```{r, Setup_and_Loading_Data, echo=FALSE}
    ...
    # rmarkdown::render("session3_Rdata.Rmd", "rmarkdown::tufte_handout", clean=TRUE)
    # rmarkdown::render("session3_Rdata.Rmd", "html_document", clean=TRUE)

    # rmarkdown::render("session3_Rdata.Rmd", "tufterhandout::html_tufte_handout", clean=TRUE)
    # rmarkdown::render("session3_Rdata.Rmd", "pdf_document", clean=TRUE)
...
Connectivity to databases not only imports tables into R, you can also run queries into the database, for example, by submitting the SQL code. You will do this in another course in more details.
